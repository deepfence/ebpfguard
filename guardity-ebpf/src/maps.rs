...
#[map]
pub(crate) static ALLOWED_SOCKET_BIND: HashMap<u64, Ports> = HashMap::with_max_entries(1024, 0);

#[map]
pub(crate) static DENIED_SOCKET_BIND: HashMap<u64, Ports> = HashMap::with_max_entries(1024, 0);
